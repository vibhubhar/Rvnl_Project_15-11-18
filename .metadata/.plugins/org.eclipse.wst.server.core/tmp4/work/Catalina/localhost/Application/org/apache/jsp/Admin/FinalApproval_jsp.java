 ...
 * Generated at: 2018-10-30 05:52:50 UTC
...
public final class FinalApproval_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (user_code!=null) {} else {user_code="0";}
 ...
 //System.out.println("code="+user_code);	
  Connection conn7 = null;                                                      
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("select[multiple], select[size] {\r\n");
      ...
      out.write("\theight: 2.0em !important;\r\n");
      ...
      out.write("    width: 40%;\r\n");
      out.write("}\r\n");
      out.write("table.table-bordered.dataTable {\r\n");
      ...
      out.write("    margin-top: 6px !important;\r\n");
      out.write("    margin-bottom: 6px !important;\r\n");
      ...
      out.write("\t        columnDefs: [{  type: 'date-uk', targets: [6] }, {\r\n");
      out.write("\t            targets: [ 0 ],\r\n");
      ...
      out.write(" -->\r\n");
      out.write(" <div class=\"absolute\" style=\"font-weight:bold\" ><h8>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Documents Under Approval] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h8>\r\n");
      out.write("\r\n");
      ...
      try {
        ...
        // /Admin/FinalApproval.jsp(358,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\t\t\t<table class=\"table table-hover table-bordered\" width=\"100%\"\r\n");
            out.write("\t\t\t\tstyle=\"background-color: #F0FFFF\" id=\"example\" class=\"display\">\r\n");
            out.write("\t\t\t\t<thead>\r\n");
            ...
            out.write("\t\t\t\t\t\t<th><b>Change Status</b></th>\r\n");
            out.write("\t\t\t\t</thead>\r\n");
...
if (rdstatus.equalsIgnoreCase("0")) { 
 ...
 if(al.contains(document_id))
            ...
            out.write("\r\n");
            out.write("\t\t\t\t\t\t<!-- <td><button id =\"FinalApp\" type=\"button\" class=\"btn btn-primary\" style=\"color:white;\" onclick=\"FinalApproval('");
            out.print(document_id);
            out.write('\'');
            out.write(',');
            out.write('\'');
            out.print(userid);
            out.write("')\">Finally Approved</button></td> -->\r\n");
            out.write("\t\t\t\t\t\t<td><input type=\"button\" class=\"btn btn-primary\"\r\n");
            out.write("\t\t\t\t\t\t\tid=\"btnShownt");
            out.print(document_id);
            out.write("\" value=\"Finally Approved\"\r\n");
            out.write("\t\t\t\t\t\t\tonclick=\"FinalApproval('");
            out.print(document_id);
            out.write('\'');
            out.write(',');
            out.write('\'');
            ...
            out.write('\'');
            out.print(userid);
            out.write("')\" disabled style=\"background:#d3d3d3;color: grey;\"/>\r\n");
            out.write("                         \r\n");
            out.write("                          ");
 }
            out.write("\r\n");
            ...
            out.write("\t\t\t\t\t\t\t\t<br> Are You Sure You Want To Finally Approve<br>\r\n");
            out.write("\t\t\t\t\t\t\t\t<br>\r\n");
            out.write("\t\t\t\t\t\t\t\t<button id=\"ok\" class=\"btn btn-primary\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\tonclick=\"finalapproval2nd('");
            out.print(document_id);
            out.write('\'');
            out.write(',');
            out.write('\'');
      ...
      try {
        ...
        // /Admin/FinalApproval.jsp(568,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /Admin/FinalApproval.jsp(596,6) name = dataSource type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_sql_005fupdate_005f0.setDataSource("jdbc/MySQLDB");
              // /Admin/FinalApproval.jsp(596,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                if (_jspx_eval_sql_005fupdate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  do {
                    out.write("\r\n");
                    out.write("  update xx_moreammendments set status ='Approved' where document_id =");
                    out.print(docid);
                    out.write("\r\n");
                    out.write("\t\t\t\t");
...
/*						String sql5 = "insert into xx_record_actions (Document_id,CurrentDate,ActionPerformed,ActionPerformedBy,Real_ActionDate) Values ('"
            ...
            out.write("\t\t\t\t<strong>Success!</strong> Document has been finally approved by\r\n");
            out.write("\t\t\t\t");
            out.print(username );
            out.write(". &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
            out.write("\t\t\t\t<button type=\"button\" class=\"btn btn-primary\" onclick=\"location.href='FinalApproval.jsp'\">Want to Approve More Documents !</button>\r\n");
            out.write("\t\t\t</div>\r\n");
            out.write("\r\n");
            out.write("\t\t");
