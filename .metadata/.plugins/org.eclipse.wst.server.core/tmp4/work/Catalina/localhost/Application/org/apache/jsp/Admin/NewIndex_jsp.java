 ...
 * Generated at: 2018-10-15 05:06:12 UTC
...
if(((String)session.getAttribute("user_name"))==null)
	...
	response.sendRedirect("admn_login.jsp");
      ...
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("$(\"#menu11\").append('<h8><span style=\"text-align:center;margin-top:4px;float:left; margin-left:30%;font-size: x-large; color:white; padding:5px; \"><b>D A S H B O A R D</u></b></span><span style=\"color:#fff;float:right;margin-top: 10px;font-weight:normal\">:&nbsp;'+usr1+'&nbsp;&nbsp;</span></h8>');\r\n");
      out.write("});\r\n");
      out.write("\r\n");
...
String arguments=null;
      ...
      try {
        ...
        // /Admin/NewIndex.jsp(160,0) name = dataSource type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_sql_005fupdate_005f0.setDataSource("jdbc/MySQLDB");
        // /Admin/NewIndex.jsp(160,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
//pageContext.setAttribute("myIndex", "1", PageContext.SESSION_SCOPE);
      ...
      out.write("<div class=\"container btn_bar\">\r\n");
      out.write("           <div class=\"row\">\r\n");
      out.write("           <div class=\"col-md-6 col-sm-8 col-xs-10\" >\r\n");
      out.write("<button type=\"button\" id=\"btnclick\" style=\"background-image:url(images/mygraph.png); box-shadow: 6px 6px 3px #777777; width:95px; height:100px; margin-left:350px; padding-left:10px; border: 1px solid gray; padding-top:50px; color:black; font-size:12px;\" class=\"img-responsive\" onclick=\"mygraph('");
      out.print(code );
