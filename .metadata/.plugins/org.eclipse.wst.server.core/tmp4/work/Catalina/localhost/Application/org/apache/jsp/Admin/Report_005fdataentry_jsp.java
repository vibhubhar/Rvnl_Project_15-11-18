 ...
 * Generated at: 2018-06-28 06:41:42 UTC
...
response.setHeader("Refresh", timeout + "; URL = admn_login.jsp");
      ...
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("$('#example6').DataTable( {\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("$('#example7').DataTable( {\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("$('#example8').DataTable( {\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("$('#example9').DataTable( {\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("\t\t\r\n");
	...
	//if (reportType.equalsIgnoreCase("zonewise")) {
      ...
      out.write("\t\tstyle=\"background-color: #F0FFFF; margin-left:20px; table-layout: auto;width: -webkit-fill-available;\" id=\"example\" class=\"display nowrap\" cellspacing=\"10\" >\r\n");
      out.write("\t\t<thead>\r\n");
	...
	//} else if (reportType.equalsIgnoreCase("zonedivwise")) {
      ...
      out.write("\t\r\n");
      out.write("\t<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("\t\tstyle=\"background-color: #F0FFFF; margin-left:20px;table-layout: auto;width:-webkit-fill-available;\" id=\"example1\" class=\"display nowrap\" cellspacing=\"0\" width=\"100%\">\r\n");
      out.write("\t\t<thead>\r\n");
      out.write("\t\t<tr class=\"success\">\r\n");
      out.write("\t\t\t<th style=\"padding: 0px 14px 24px 0px;\">S.No.</th>\r\n");
      out.write("\t\t\t<th style=\"padding: 0px 18px 17px 14px; \">Zone</th>\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example9\" class=\"display nowrap\" cellspacing=\"0\" >\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
      out.write("\t<th style=\"padding: 0px 14px 24px 0px;\">S.No.</th>\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("<span style=\"margin-left:20px; color:blue; font-weight:bold; font-size:18px;\">PIU wise Project-Package Creation Summary</span><br>\r\n");
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example2\" class=\"display nowrap\" cellspacing=\"0\">\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
      out.write("\t<th style=\"padding: 0px 14px 24px 0px;\">S.No.</th>\r\n");
      out.write("\t<th style=\"padding: 0px 18px 17px 14px; \">PIU</th>\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example3\" class=\"display nowrap\" cellspacing=\"0\">\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
      out.write("\t<th style=\"padding: 0px 14px 24px 0px;\">S.No.</th>\r\n");
      out.write("\t<th style=\"padding: 0px 18px 17px 14px; \">PIU</th>\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("\r\n");
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example4\" class=\"display nowrap\" cellspacing=\"0\">\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("\r\n");
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example5\" class=\"display nowrap\" cellspacing=\"0\" >\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("\r\n");
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example6\" class=\"display nowrap\" cellspacing=\"0\">\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("\r\n");
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example7\" class=\"display nowrap\" cellspacing=\"0\" >\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
      out.write("\t<th style=\"padding: 0px 14px 24px 0px;\">S.No.</th>\r\n");
...
rs = stmt.executeQuery(query);
      ...
      out.write("\r\n");
      out.write("<table border=1 class=\"table table-hover table-bordered\"\r\n");
      out.write("style=\"background-color: #F0FFFF; margin-left:20px;width: -webkit-fill-available;\" id=\"example8\" class=\"display nowrap\" cellspacing=\"0\" >\r\n");
      out.write("<thead>\r\n");
      out.write("<tr class=\"success\">\r\n");
      out.write("\t<th style=\"padding: 0px 14px 24px 0px;\">S.No.</th>\r\n");
      out.write("\t<th style=\"padding: 0px 18px 17px 14px; \">Type</th>\r\n");
