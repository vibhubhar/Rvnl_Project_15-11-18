...
<div class="container" style="margin-top:30px; padding: 20px; width:100%;">
	...
	<div class="box-body">	
		<table class="table table-hover table-bordered" style="margin: 0px 0px 0px 0px;" >
			<tr class="success"><td style="width: 30%;"><h4 style="text-align:center;"><font color="grey">Create User</font></h4></td><td><h4 style="text-align:center;">
			...
			<td><input type = "radio" name="myRadios" id="User" value ="1" style='margin-left:80px' checked="checked"><b>Create User</b> &nbsp;&nbsp;
				...
				<div id ="User_1" class="desc" style="margin: 20px 0px 0px 0px;font-size:11px;">
				<table style="border:0px solid black;margin:-20px 0px 0px 0px;" ><tr class="success">
				<td style="background-color: aliceblue;width:30%;vertical-align: baseline;display: inline-block;">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font color="red">*</font>Required Field<br><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Type :
					<font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<select name="Type" id="Type" style="height: 27px;">
...
margin-left: 61px;"></div><br> <br> </div>
				...
				<td valign="top" style="display: inline-block;width:70%;">
				
				<table style="margin: -30px 0px 0px 00px;" ><tr><td>
				<div style="position: relative;margin:0px;width: 100%%;">
						&nbsp;&nbsp;&nbsp;<strong>Zone:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<select name='Zone' id ="Zoneunderlist" data-plugin="selectpicker" data-live-search="true"
				...
				<select name=OrgUnderlist id="OrgUnderlist" data-plugin="selectpicker" data-live-search="true" onchange="showOrgUnderList(this.value)">
					...
					<div id = 'PIU_Table' style="position: relative;margin:0px;width: 100%%;">
			...
			<div id = "User_2" class="desc" style="display:none;width: 100%;margin: 0px 0px 0px 0px;font-size:12px;" >
			<div style="width:30%;background:aliceblue;vertical-align:top;display:inline-block;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PIU Of RVNL:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
margin-left: 61px;"></div> <br>
		 ...
		 <input type ='checkbox' name='Zone_id' id='Zone_id' style="margin-left:185px" value="<%=zone1%>"> <%=zone1%><br>			      
			...
			<div style="width:69%; display:inline-block;vertical-align:top;word-break: break-word;">	
<div id="display_1" style="display: table;">				
 <table ><tr><td>
						<%-- &nbsp;&nbsp;&nbsp;Zone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<select name=PIU_name id="PIUunderList" data-plugin="selectpicker" data-live-search="true" onchange="showDeptUnderList1(this.value)"
					...
					<div id = 'PIU_Table11' class="scrollit" style="height:auto;">
<table class="table table-hover table-bordered"
				style="background-color: #F0FFFF" id="example" class="display" height="1000px">
				<thead>
					<tr class="success">
						<th width="10%"><b>SNo</b></th>
						<th width="10%"><b>PIU</b></th>
						<th width="10%"><b>Department</b></th>	
								<th width="10%"><b>User Id</b></th>
						
						<th width="10%">Officer Name</b></th>
						<th width="10%"><b>Email Id</b></th>
						<th width="10%"><b>Contact No</b></th>
					
						<th width="10%"><b>Modify</b></th>
						<th width="10%"><b>Reset Password</b></th>
