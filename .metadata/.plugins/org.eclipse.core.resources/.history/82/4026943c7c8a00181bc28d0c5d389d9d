...
function mywinClose() {
	...
	setTimeout(function(){var parent1=window.open("","report_master"); parent1.close(); },(sessionTimeout1*1000-500));
}
</script>
	...
	$(document).ready(function() {
		...
		if(docType1==null){
			...
			docType1="Document Type :"+docType1;
		}
		...
		if(t31==null){
			...
			t31="Under Approval for more than (days) :"+t31;
		}
...
<body onload="mywinClose();">
	<div style="text-align: center;font-size: 18px;"><b>RVNL Document Report (DETAILED REPORT) </b></div></br>
	<%
	...
	<%
				...
				if(t3!="" || t3=="0" || t3==null){
						...
						<th width="250px" align="left" style="background-color: #ffff;"><font size=3px>
								...
								<INPUT Type="hidden" name="t31" id="t31" value="<%=t3 %>" />
						</font></th>
						<%
						}
	%></tr></table>
