...
String nrly1=null, nrvnl1=null, nothers1=null, ndivn1=null, nappd2=null;
...
if (filter1 != "") {
	query=query+" and "+filter1;//" and document_status='pending' and "+filter1;
}
/*
else {
...
*/
String 	query1="select Count(if (Type='MOR' and document_status='pending', 1 , null)) as nrly,  Count(if (Type='RVNL'  and document_status='pending', 1 , null)) as nrvnl,  Count(if (Type='Others'  and document_status='pending', 1 , null)) as nothers, Count(if (Type='MOR' and division_id="+div_id1+"  and document_status='pending', 1 , null)) as ndivn, Count(if (document_status='finally approved', 1 , null)) as nappd2 from (" + query+ ") as pkrly";
...
<td valign="top">
		...
		<li class="pan1"><a class="pk2">Nos. of documents approved and closed = <%=nappd2 %> </a></li>
