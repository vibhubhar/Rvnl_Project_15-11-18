...
//System.out.println("zone-  "+zone+"  index "+index+"--"+id);
...
// ResultSet rs = stmt.executeQuery("select  division_name from xx_divisions_map where ext_zone_id = (select zone_id from xx_zones_master where zone_name = '"+country+"' ");  
 ...
 while(rs.next()){
  ...
  buffer=buffer+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type='checkbox'  name='divisions"+id+":"+index+"' id='divisions"+id+":"+index+"' value='"+division_name+"'> "+division_name;  
