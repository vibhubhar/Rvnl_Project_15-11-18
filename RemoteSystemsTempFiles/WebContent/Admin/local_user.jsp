...
%>
<%-- <div><h4 style='width: 350px; margin-left: 27px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Create User</h4></div>
...
<h4 align="left"  style='width: 300px; margin-left:27px'><font style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome&nbsp;</font><font color="#99CC00">:&nbsp;<%=(String)session.getAttribute("user_name") %></font></h4>
 ...
 <div class="absolute" style="font-weight:bold" ><h8>&nbsp;&nbsp;&nbsp;[Users] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h8>
...
<div class="container" style="margin-top:70px; padding: 20px; width:1500px;">
	...
	<c:if test="${param.Project_stage == null}">	
		<table class="table table-hover table-bordered" style="margin: -28px 0px 19px 0px;" >
			  
			<tr class="success"><td style="width: 32.5%;" ><h3 style="text-align:center;"><font color="grey">Create User</font></h3></td><td><h3 style="text-align:center;">
			<font color="grey">List of Users</font></h3></td></tr>
			<td style="display:none;"><input type = "radio" name="myRadios" id="User" value ="1" style='margin-left:80px' checked="checked"><b>Create User</b> &nbsp;&nbsp;
...
%>
				...
				<div id ="User_1" class="desc"  width="33%" style="margin: 0px 0px 0px 0px;">
				<table style="margin:-20px 0px 0px 0px;" ><tr class="success"><td style="background-color: aliceblue; width: 33%;" valign="top">
				<br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
margin-left: 61px;"></div><br> <br> </div>
				...
				<font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <select name="Role" id="Role" style="width: 205px;" >
				...
				<select name=PIU_name id="PIU_name" 
				  ...
				  <font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					style="width: 205px">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Designation:
					<font color="red">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<div id ="DesgDiv_RVNL2" style='display: inline;'><select name='designation_RVNL2' id='designation_RVNL2' style="width: 205px">
				...
				<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Role:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   ...
				   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Department:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<select name='designation_RVNL1' id='designation_RVNL1' style="width: 205px">
						<option value="none">-- Select Designation --</option>						  
				</select> <br /> <br /></div>
				...
				<table style="margin: 0px 0px 340px 20px;">
					...
					style="width: 205px;"  data-plugin="selectpicker" data-live-search="true" onchange="showDivisionunderlist(this.value)">
				...
				<font color="grey">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>PIU Of RVNL:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<select name=PIU_name id="PIUunderList" onchange="showDeptUnderList(this.value)"
					style="width: 205px" data-plugin="selectpicker" data-live-search="true">
    ...
    margin: -4px -46px 53px -1px; width: 66%;"></div>
				...
				<!-- commenting this data---------------------------------------------------------- -->
					...
					onchange="showDivisionunderlist(this.value)">
						...
						<%
								...
								rs = stmt.executeQuery("Select * from xx_zones_master where ");
	...
	<%-- 		
			<div id = "User_2" class="desc" style="display:none;background:aliceblue;width: 40%;margin: -20px 0px 0px 0px;" >
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PIU Of RVNL:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<select name=PIU_Id id="PIU_Id" 
					style="width: 205px;margin-top: 23px;" onchange="javascript:localadmnpiuchange(this.value);">
						...
						Statement stmt1 = null;
							...
							//conn = ds.getConnection();
								...
								String sql13 = "select * from xx_piu_master";
				   ...
				   <br />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="User_name" id ="User_name1" type="text" class="textfield" onkeyup="loadXMLDoc('User_name1','err1')"
...
margin-left: 61px;"></div> 	 <br> <br>
 <label for="chkShowPassword1">
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="chkShowPassword1" />
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Officer Name :&nbsp;&nbsp;
					<input name="Officer_Name" id="Officer_Name" type="text" class="textfield"
					 width="200" style="width: 205px"> <br> <br>
					 
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email Id :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="Email" id="Email" type="text" class="textfield" onkeyup="checkemail1()"
...
margin-left: 61px;"></div> <br> <br>
			...
			<!--  <div style='display:;' id='business_RVNL'> -->&nbsp;
				  ...
				  <select name=departme id="departme" style="width: 205px">
						...
						String sql14 = "select department_name from xx_departments_master where type ='RVNL'";
				  ...
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Zone:<br>		
					<%
                            String sql15 = "select * from xx_zones_master";
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			...
			<button type="button" id="btnclick" class="btn btn-primary" onclick="validateUserLocal();">Submit</button> 
			
			
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="reset" class="btn btn-primary" value="Cancel" onClick="refreshAndClose()" />
	...
	/*
		    ...
		    ps9 = conn.prepareStatement(sql9);
				...
				if( !uname.equalsIgnoreCase("") )  {
					...
					<script type="text/javascript">
					var r = confirm("Do you want to update user ?"); 
					var x;
					if(r==true) {
						x="OK";
				//	alert("Right");
					 document.loginForm11.Project_stage.value = "second";
					...
					// document.loginForm11.demo.value=x;
					</script>			
		-->			<%
		...
		if(Type.equalsIgnoreCase("RVNL")) {
			   ...
			   INSERT INTO xx_user_master (User_name,Password,Role,Type,Department_id,Designation_id,PIU_Id,Officer_Name,Email_Id,Contact_No,Created_by,Date_created) VALUES ('<%=User_name%>','<%=Password%>','<%=Role%>','<%=Type%>','<%=dept_id%>','<%=desg_id%>','<%=piu_id%>','<%=Officer_Name%>','<%=Email_Id%>','<%=Contact_No%>','<%=user %>', now());
			</sql:update>
...
//sms code ends here
				...
				<button type="button" class="btn btn-primary" onclick="location.href='local_user.jsp'">Want to create more Users</button></div>
		...
		//else if(str.equalsIgnoreCase("fourth")){	
			...
			Connection conn =null;PreparedStatement ps5 =null,ps6=null,ps7=null,ps8=null ,ps9=null;ResultSet rs5=null, rs6=null,rs7=null,rs8=null,rs9=null;
				...
				while (rs8.next()) {
				 ...
				 %>
				<%--<sql:update dataSource="jdbc/MySQLDB" var="rs">
				   INSERT INTO xx_user_master (User_name,Password,Officer_Name,Email_Id,Contact_No,PIU_ID,Department_id,Type,Role) VALUES ('<%=username%>','<%=pwds%>','<%=officers %>','<%=emails %>','<%=phones %>','<%=pius_id %>','<%=departme_id %>','RVNL','LocalUser');
				</sql:update> --%>
				<%		
				/* 
			...
			for (int k = 0; k < zoneCheck.length; k++) {
	 		 ...
	 		 // }%>
	 		  <!-- <div class="alert alert-success" align="center"><strong>Success!</strong> Local Admin created successfully.</div> -->
	 		  <%
			//conn.close();
	//	}catch(Exception e){
		//	e.printStackTrace();
