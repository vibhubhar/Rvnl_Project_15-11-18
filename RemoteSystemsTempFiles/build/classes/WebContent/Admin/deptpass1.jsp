...
conn = ds.getConnection();
 if(depart!=null){
                 ...
                 String query = "select * from xx_departments_master where Department_Name="+depart+" and Type='"+type+"'"; 
	 ...
	 String query1 = "select * from xx_documentattributes_master where Document_Type='"+depart+"' and Type='"+type+"'";
