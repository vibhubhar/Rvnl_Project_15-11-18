...
<%
            ...
            String projtype=request.getParameter("ver");
...
conn = ds.getConnection();
                 ...
                 String query = "select * from xx_projecttypes_master where Project_type='"+projtype+"'"; 
                 ...
                 ps3 = conn.prepareStatement(query);
                    ...
                    {   
                        ...
                        out.println("Project Type already exists");
                        out.println("</font>");
