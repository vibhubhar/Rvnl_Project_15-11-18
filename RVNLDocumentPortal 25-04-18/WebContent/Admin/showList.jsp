...
if(type.equalsIgnoreCase("zone")) {
	...
	buffer="<table class='table table-hover table-bordered'><tr class ='success'><td class='ListOfTables'><font color='grey'><b>Sno</b></font></td><td class='ListOfTables'><font color='grey'><b>Zone Name</b></font></td>"+
